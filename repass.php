...
<html lang="en">
  ...
  <body>
    ...
    <form action="repass_act.php" method="post" class="box">
        <div class="login-area">
            <h1 style="align = center">Reset Password</h1>
            <input type="text" class="username" placeholder="Username" name="username">
            <input type="password" class="pass" placeholder="New Password" name="pass">
